Shader "Daniel/Effects/SphericalMask"
{
    Properties
    {
		...
		//_Radius("Sphere Radius", Range(0, 5)) = 0
		//_Softness("Sphere Softness", Range(0, 1)) = 0
    }
    SubShader
    {
		...
		// Spherical Mask (w/ global values)
		float4 _Position;
		half _Radius;
		half _Softness;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
			...
			// Create grayscale by adding the three channels, and multypling them by '0.333'
			// Multiplying the channels by '0.333' is faster than dividing them by '3'
